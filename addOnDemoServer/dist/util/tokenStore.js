...
var DB_PATH = path_1.default.join(__dirname, "../data/tokens.db");
var TokenStore = /** @class */ (function () {
    ...
    TokenStore.prototype.setToken = function (at, rt, apiKey) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            _this.db.serialize(function () {
                ...
                (_a = _this.db) === null || _a === void 0 ? void 0 : _a.run("DELETE FROM tokens", function (err) {
                    ...
                    (_a = _this.db) === null || _a === void 0 ? void 0 : _a.run("INSERT INTO tokens (at, rt, apiKey) VALUES (?, ?, ?)", [at, rt, apiKey], function (err) {
                        if (err) {
                            reject(err);
                        }
                        else {
    ...
    TokenStore.prototype.getToken = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.db.get("SELECT at, rt, apiKey FROM tokens ORDER BY id DESC LIMIT 1", function (err, row) {
                if (err) {
                    reject(err);
                }
                else {
                    if (row) {
                        resolve({ at: row.at, rt: row.rt, apiKey: row.apiKey });
                    }
                    else {
                        resolve(null);
                    }
