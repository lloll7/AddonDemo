...
var getAt = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error("获取Token失败:", error_1);
                return [2 /*return*/, ""];
...
var setAt = function (at, rt, apiKey, region, account) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                console.error("存储Token失败:", error_2);
...
exports.setAt = setAt;
var clearAt = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                error_3 = _a.sent();
                console.error("清除Token失败:", error_3);
                return [2 /*return*/, false];
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.clearAt = clearAt;
